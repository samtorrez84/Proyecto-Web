  ...
  return (
    <div className="flex items-center justify-between p-4 bg-gray-900" style={{ backgroundImage: "url('/fondo1.png')" }} >
      <div className="flex items-center">
        <Link to="/equipos" className="flex items-center">
      ...
      <div className="flex items-center">
        {isAuthenticated ? (
          ...
          <Link to="/register" className="mx-2 px-4 py-2 bg-custom-blue text-white rounded-full hover:bg-custom-green hover:text-black font-bold">Regístrate</Link>
          </>
        )}
      </div>
    </div>
